...
\caption{#2}
{\footnotesize Źródło: #3, źródło danych: #4}
\label{#1}
\end{figure}}
...
\newcommand{\figdraft}[4]{
\begin{figure}[H]
\includegraphics[width=\textwidth, draft]{#1}
\caption{#2}
{\footnotesize Źródło: #3, źródło danych: #4}
\label{#1}
\end{figure}}

\newcommand{\halffigdraft}[4]{
\begin{figure}[H]
\includegraphics[width=0.5\textwidth, draft]{#1}
\caption{#2}
{\footnotesize Źródło: #3, źródło danych: #4}
\label{#1}
\end{figure}}

\newcommand{\halftable}[2]{
\begin{table}[H]
\includegraphics[width=0.5\textwidth]{#1}
\caption{#2}
\label{#1}
