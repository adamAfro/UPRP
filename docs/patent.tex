...
\begin{figure}[H]\centering
\includegraphics[width=\textwidth]{../registry/geodisp-NA.png}
...
\begin{figure}[H]\centering
\includegraphics[width=\textwidth]{../registry/IPC-NA-geodisp.png}
...
\begin{figure}[H]\centering
\includegraphics[width=\textwidth]{../registry/IPC-NA-periods.png}
\caption{Ilość rejestrów kategorii
