...
\columnbreak
\halffig{../fig/F-geoloc-eval.regs.png}
...
\begin{multicols}{2}
\halffig{../fig/F-grant-delay.regs.png}{Długość okresu między aplikacją a przyznaniem ochrony patentowej}
\columnbreak
\halffig{../fig/F-grant-delay-13-22.regs.png}{Długość okresu między aplikacją a przyznaniem ochrony patentowej w badanym okresie}
\end{multicols}
